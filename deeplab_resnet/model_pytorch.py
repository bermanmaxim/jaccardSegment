# Converted by kaffe to tensorflow
# removed tf references
# for loading in pytorch.

# from kaffe.tensorflow import Network

from network_pytorch import Network
...
class DeepLabResNetModel(Network):
    def setup(self, is_training):
        ...
        (self.feed('data')
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn_conv1')
        ...
        (self.feed('pool1')
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn2a_branch2a')
             .conv(3, 3, 64, 1, 1, biased=False, relu=False, name='res2a_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn2a_branch2b')
        ...
        (self.feed('bn2a_branch1', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn2b_branch2a')
             .conv(3, 3, 64, 1, 1, biased=False, relu=False, name='res2b_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn2b_branch2b')
        ...
        (self.feed('res2a_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn2c_branch2a')
             .conv(3, 3, 64, 1, 1, biased=False, relu=False, name='res2c_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn2c_branch2b')
        ...
        (self.feed('res2c_relu')
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn3a_branch2a')
             .conv(3, 3, 128, 1, 1, biased=False, relu=False, name='res3a_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn3a_branch2b')
        ...
        (self.feed('bn3a_branch1', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn3b1_branch2a')
             .conv(3, 3, 128, 1, 1, biased=False, relu=False, name='res3b1_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn3b1_branch2b')
        ...
        (self.feed('res3a_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn3b2_branch2a')
             .conv(3, 3, 128, 1, 1, biased=False, relu=False, name='res3b2_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn3b2_branch2b')
        ...
        (self.feed('res3b1_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn3b3_branch2a')
             .conv(3, 3, 128, 1, 1, biased=False, relu=False, name='res3b3_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn3b3_branch2b')
        ...
        (self.feed('res3b3_relu')
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4a_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4a_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4a_branch2b')
        ...
        (self.feed('bn4a_branch1', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b1_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b1_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b1_branch2b')
        ...
        (self.feed('res4a_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b2_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b2_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b2_branch2b')
        ...
        (self.feed('res4b1_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b3_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b3_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b3_branch2b')
        ...
        (self.feed('res4b2_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b4_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b4_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b4_branch2b')
        ...
        (self.feed('res4b3_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b5_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b5_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b5_branch2b')
        ...
        (self.feed('res4b4_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b6_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b6_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b6_branch2b')
        ...
        (self.feed('res4b5_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b7_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b7_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b7_branch2b')
        ...
        (self.feed('res4b6_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b8_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b8_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b8_branch2b')
        ...
        (self.feed('res4b7_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b9_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b9_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b9_branch2b')
        ...
        (self.feed('res4b8_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b10_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b10_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b10_branch2b')
        ...
        (self.feed('res4b9_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b11_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b11_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b11_branch2b')
        ...
        (self.feed('res4b10_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b12_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b12_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b12_branch2b')
        ...
        (self.feed('res4b11_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b13_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b13_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b13_branch2b')
        ...
        (self.feed('res4b12_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b14_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b14_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b14_branch2b')
        ...
        (self.feed('res4b13_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b15_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b15_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b15_branch2b')
        ...
        (self.feed('res4b14_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b16_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b16_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b16_branch2b')
        ...
        (self.feed('res4b15_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b17_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b17_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b17_branch2b')
        ...
        (self.feed('res4b16_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b18_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b18_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b18_branch2b')
        ...
        (self.feed('res4b17_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b19_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b19_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b19_branch2b')
        ...
        (self.feed('res4b18_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b20_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b20_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b20_branch2b')
        ...
        (self.feed('res4b19_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b21_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b21_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b21_branch2b')
        ...
        (self.feed('res4b20_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b22_branch2a')
             .atrous_conv(3, 3, 256, 2, padding='SAME', biased=False, relu=False, name='res4b22_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn4b22_branch2b')
        ...
        (self.feed('res4b22_relu')
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn5a_branch2a')
             .atrous_conv(3, 3, 512, 4, padding='SAME', biased=False, relu=False, name='res5a_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn5a_branch2b')
        ...
        (self.feed('bn5a_branch1', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn5b_branch2a')
             .atrous_conv(3, 3, 512, 4, padding='SAME', biased=False, relu=False, name='res5b_branch2b')
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn5b_branch2b')
        ...
        (self.feed('res5a_relu', 
             ...
             .batch_normalization(is_training=is_training, activation_fn='relu', name='bn5c_branch2a')
             .atrous_conv(3, 3, 512, 4, padding='SAME', biased=False, relu=False, name='res5c_branch2b')
             .batch_normalization(activation_fn='relu', name='bn5c_branch2b', is_training=is_training)
